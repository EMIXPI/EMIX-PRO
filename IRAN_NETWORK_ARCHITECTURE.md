...
**Version:** v11.4.0-builder · **Modules:** `domestic_route_engine.py`, `iran_gateway.py`, `capability_engine.py` · **UI:** مسیریابی هوشمند (pg-routing) + 🇮🇷 پروکسی ایران (pg-iranproxy) + ساخت کانفیگ routing step
